...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:0px solid #000;">
	<thead>
		...
		<tr>
			...
			<th class="wd12 bl bt plr3">RKAP 20XX</th>
			<th class="wd12 bl bt plr3">Rencana TW.II 20XX</th>
			<th class="wd12 bl bt plr3">Realisasi TW.II 20XX</th>
			<th class="wd5 bl bt plr3">%</th>
			<th class="wd12 bl bt plr3">Rencana s.d TW.II 20XX</th>
			<th class="wd12 bl bt plr3">Realisasi s.d TW.II 20XX</th>
			<th class="wd5 bl bt plr3">%</th>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:0px solid #000;font-size:12px;">
	<tbody>
		<tr>
			<td class="bl bt al plr3">BEBAN USAHA</td>
		...
		@endforeach
		<tr>
			<td class="bl bt ac plr3">Jumlah</td>
