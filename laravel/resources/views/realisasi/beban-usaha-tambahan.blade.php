...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:0px solid #000;">
	<thead>
		...
		<tr>
			<td class="bl bt bb ac fs10">1</td>
			<td class="bl bt bb ac fs10">2</td>
			<td class="bl bt bb ac fs10">3</td>
			<td class="bl bt bb ac fs10">4</td>
			<td class="bl bt bb ac fs10">5</td>
			<td class="bl bt bb ac fs10">6</td>
			<td class="bl bt bb ac fs10">7</td>
			<td class="bl bt bb ac fs10">8</td>
			<td class="bl bt br bb ac fs10">9</td>
		</tr>
	</thead>
</table>
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:0px solid #000;font-size:11px;">
	<tbody>
		...
		@endforeach
		<tr>
			<td class="bl bt bb ac plr3 fb">Jumlah</td>
