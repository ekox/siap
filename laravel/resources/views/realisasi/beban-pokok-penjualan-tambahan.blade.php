...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:0px solid #000;">
	<thead>
		<tr>
			<th colspan="9" class="">
				<h3>RINCIAN REALISASI BEBAN POKOK PENJUALAN TAHUN {{$tahun}}</h3>
				<br>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:0px solid #000;font-size:12px;">
	<tbody>
		<tr>
			<td class="bl bt al fb plr3">Beban Pokok Penjualan</td>
		...
		<tr>
			<td class="bl bt al plr3 fb">Beban Pokok Pengelolaan Aset</td>
			<td class="bl bt ar plr3">0</td>
			<td class="bl bt ar plr3">0</td>
			<td class="bl bt ar plr3">0</td>
			<td class="bl bt ar plr3">0</td>
